...
function menuopencost(datato="onboardlistshop")
{
...
<div id="cartbuttons" style="background:rgba(7,144,241, 0.8);padding:5px 7px 3px 3px;border-radius:9px;width:41px;min-height: 9px;position: fixed;z-index: 999;bottom:0;cursor: pointer;margin:0px 0 33.3vh 3px;">


<img class="iconkhususpibro" src="<?php echo $lokasiweb; ?>/scannerbutton.png" style="width:91%;height: auto;margin: 4px 0 4px 4px;" onclick="menuopencost('scannner');" />
<?php
if (@$gerdeweedysaghakey1!="")
{
if (@$gerdeweedysaghakey1!=mengacakstring("2024GSHforever",5))
{ ?><img class="iconkhususpibro" src="https://pinetmart.com/box/keranjangbelanjaanbg2.png" style="width:100%;height: auto;" onclick="menuopencost('onboardlistshop');" />
<?php };
if (@lihatisikolomtertentu("data_pioneerweb","dataidutama_pioneer",@$gerdeweedysaghakey1,"level_akun")=="kasir")
{ if ($runonmobile=="desk")
    { $parttok=@lihatisikolomtertentu("","","","kodekeagenan","select * from addforusa where liszkasnerr like '%".$gerdeweedysaghakey1."%' "); 
    $parttok2=@lihatisikolomtertentu("","","","dataidutama_pioneer","select * from addforusa where liszkasnerr like '%".$gerdeweedysaghakey1."%' ");
    if ($parttok!="")
    { ?>
    <a href="<?php echo $lokasiweb; ?>kasinomode.php?bukakas=<?php echo $parttok2; ?>||<?php echo $parttok; ?>" ><img src="https://pinetmart.com/box/pi-coin.png" style="width:97%;height: auto;margin: 4px 0 3px 3px;" title="buka mode kasir"/></a>
    <a href="<?php echo $lokasiweb; ?>upsidedown.php?opengerai=<?php echo $parttok2; ?>||<?php echo $parttok; ?>" ><img src="<?php echo $lokasiweb; ?>box/-gerai-sirrul.png" style="width:98%;height: auto;margin: 4px 0 3px 3px;" title="buka kelola barang-barang di gerai"/></a>
...
{
if ((@lihatisikolomtertentu("data_pioneerweb","dataidutama_pioneer",@$gerdeweedysaghakey1,"level_akun")!="kurir")&&(@lihatisikolomtertentu("data_pioneerweb","dataidutama_pioneer",@$gerdeweedysaghakey1,"level_akun")!="penguna"))
{
 ?><img src="<?php echo $lokasiweb; ?>box/-gerai-sirrul.png" style="width:98%;height: auto;margin: 4px 0 3px 3px;" onclick="menuopencost('onboardprodigy');" />
<?php }; 
}

 ?>
<img src="https://pinetmart.com/logoAI.png" style="width:98%;height: auto;margin: 4px 0 3px 3px;" onclick="menuopencost('onboardmarket');" title="Buka Market Place"/>
...
<div class="container vmiddle"> <div class="row text-center"> <h1 class="judulberanimasiwhite">Gerai Sirrul</h1> </div> </div> </div> <!-- /.home --> <!-- CONTENT --> <div class="content"> 
<div class="container">
<div class="row">
...
{ ?>
<div class="col-sm-4 sidelogos" style="text-align: center;"> <img src="<?php echo $lokasiweb; ?>box/sirrul_logo.png" style="width:50%;height: auto;"/><p style="text-align: justify;">Silahkan Lakukan Pendaftaran  / Login / Scan QR-Code Gerai <?php echo $namasekolah; ?>.</p> </div>
...
function lakukanloginfromlogin() { 
 ...
 alert(data);
<?php $indexoftrance="";
if (!empty($_REQUEST["pullbear"]))
{ $proidxz=$_REQUEST["pullbear"];
$proidxz=@explode("||",@$proidxz);
if (@count($proidxz)>2)
{
$indexoftrance=@lihatisikolomtertentu("","","","kodekeagenan","select * from addfornewbelanja where datownerz='".$proidxz[1]."||".$proidxz[2]."' and kodekeagenan='".$proidxz[0]."' order by kodekeagenan desc ");
}; }
if ($indexoftrance==""){
 ?>
 window.location.href='<?php echo $lokasiweb; ?>gerai/';
 <?php } else { ?>
 window.location.href='https://sirrul.pinetmart.com/paygerai.php?dataz=<?php echo $_REQUEST["pullbear"].(@$_REQUEST["launchfor"]==="mobile"?"&launchfor=mobile":""); ?>';
 <?php }; ?>
 return false;
        });
return false;
...
jQuery.ajax({
            ...
            alert(hasilnya);
            window.location.href='<?php echo $lokasiweb."gerai/".(@$_REQUEST["launchfor"]==="mobile"?"?launchfor=mobile":""); ?>';
            return false;
            },
        });
...
<div  style="display:none;" class="tohidesbox" id="todoopenonboardlistshop">
<div id="subboxonboardlistshop">

</div>
</div>

<div  style="display:none;" class="tohidesbox" id="todoopenonboardprodigy">
<div id="subboxonboardprodigy">

</div>
</div>
<div  style="display:none;" class="tohidesbox" id="todoopenonboardmarket">
<div id="subboxonboardmarket" style="width:98vw !important;">
